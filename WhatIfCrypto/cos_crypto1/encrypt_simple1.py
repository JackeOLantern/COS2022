...
class Encryptor(object):
    ...
    def encrypt(self, plaintext):
        # WHILE not multiple of 16 bits, pads with 0
        print("Before : "+str(len(plaintext)))
        while len(plaintext)%16:
            plaintext += b'\0'
        print("After : "+str(len(plaintext)))
...
if __name__ == '__main__':
    ...
    if args.output_file:
        ...
        print('Your file after encryption is', ciphertext.hex(), " : ", str(ciphertext))
